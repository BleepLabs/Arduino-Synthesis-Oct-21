...
int16_t granular_array[32000]; //taht's the max the granular libray can use
...
void setup() {
  ...
  granular1.begin(granular_array, 32000); //array, max_length

  mixer1.gain(0, .5); //from audio input
  mixer1.gain(1, .5); //from granular effect
