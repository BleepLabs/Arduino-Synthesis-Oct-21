...
AudioSynthWaveform       waveform1;      //xy=348,244
AudioSynthWaveform       waveform2;      //xy=355,295
AudioMixer4              mixer1;         //xy=517,267
AudioFilterStateVariable filter1;        //xy=644,337
AudioAmplifier           amp1;           //xy=770,278
AudioOutputI2S           i2s1;           //xy=940,253
...
AudioControlSGTL5000     sgtl5000_1;     //xy=757,414
...
waveform1.begin(1, 440.0, WAVEFORM_SQUARE);
...
void loop() {
  ...
  cutoff_freq = map(potRead(2), 0, 1.0, 0, 15000.0);
  filter1.frequency(cutoff_freq);
