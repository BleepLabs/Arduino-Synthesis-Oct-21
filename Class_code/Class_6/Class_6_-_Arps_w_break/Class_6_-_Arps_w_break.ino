...
AudioSynthWaveform       waveform1;      //xy=117,117
AudioSynthWaveform       waveform2;      //xy=124,168
AudioMixer4              mixer1;         //xy=327,138
AudioEffectEnvelope      envelope1;      //xy=484,138
AudioAmplifier           amp1;           //xy=641,127
AudioOutputI2S           i2s1;           //xy=803,131
...
AudioControlSGTL5000     sgtl5000_1;     //xy=580,289
...
void loop() {
  ...
  for (int i = 0; i < 8; i = i + 1)  {
    if (buttons[i].fell() && gate_enable == 0) {
      ...
      current_button = i;
      Serial.print(i);Serial.println(" fell");
      break;
    }
  }
